/* tslint:disable */
/* eslint-disable */
export function read_filem(a: number, b: number): number;
export function read_filen(a: number, b: number): number;
export function generate_params(a: number, b: number, c: number): number;
