...
import type {
  ForeignOmnibridge,
  ForeignOmnibridgeInterface,
} from "../ForeignOmnibridge";
...
const _abi = [
  ...
  },
  {
    ...
    name: "interestImplementation",
    outputs: [
      {
        internalType: "contract IInterestImplementation",
        name: "",
        type: "address",
      },
    ],
...
export class ForeignOmnibridge__factory {
  static readonly abi = _abi;
  static createInterface(): ForeignOmnibridgeInterface {
    return new utils.Interface(_abi) as ForeignOmnibridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ForeignOmnibridge {
    return new Contract(address, _abi, signerOrProvider) as ForeignOmnibridge;
  }
}
