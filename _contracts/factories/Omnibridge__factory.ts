...
import type { Omnibridge, OmnibridgeInterface } from "../Omnibridge";
...
export class Omnibridge__factory {
  static readonly abi = _abi;
  static createInterface(): OmnibridgeInterface {
    return new utils.Interface(_abi) as OmnibridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Omnibridge {
    return new Contract(address, _abi, signerOrProvider) as Omnibridge;
  }
}
